...
function addEventListeners() {
   ...
   if (document.readyState == "complete") {
      ...
      addSpotButton.addEventListener("mousedown", addSpotButtonClick);
      removeSingleButton.addEventListener("mousedown", removeSingleClick);
      removeAllButton.addEventListener("mousedown", removeAllClick);
   }
}
