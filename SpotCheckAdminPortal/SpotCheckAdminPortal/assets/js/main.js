$(document).ready(function($) {
	...
	$('#lotBtn').click(() => {
	  ...
	  parkingLot.lotName = $('#lotName').val();
	  parkingLot.address = $('#address').val();
	  parkingLot.city = $('#city').val();
	  parkingLot.state = $('#state').val();
	  parkingLot.zipCode = $('#zip').val();
	  parkingLot.openSpots = $('#totalSpots').val();

	  $.post('http://173.91.255.135:8080/SpotCheckServer-2.1.8.RELEASE/parkingLot/createNewParkingLot',
	    {
