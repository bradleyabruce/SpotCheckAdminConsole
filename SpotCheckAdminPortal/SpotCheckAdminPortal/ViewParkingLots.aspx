...
<body id="viewParkingLotBody" runat="server">
   ...
   <form id="parkingLotForm" runat="server">

      <div id="loadingParkingLotDiv" runat="server">

         <!--Loading Window -->
         <asp:UpdateProgress runat="server" ID="parkingLotUpdateProgress" AssociatedUpdatePanelID="parkingLotUpdatePanel">
            <ProgressTemplate>
      ...
      <div id="wrapper">
         ...
         <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
               ...
               <!-- Begin Page Content -->
               <div class="container-fluid" runat="server" id="parkingLotBody" style="position: relative">
