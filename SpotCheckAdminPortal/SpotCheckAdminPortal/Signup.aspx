<%@ Page Language="C#" Inherits="SpotCheckAdminPortal.Signup" %>
<!DOCTYPE html>
<html>
<head runat="server">
    <meta charset="utf-8">
                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-md-5 relative align-self-center">
                            <div id="register" class="bg-white rounded pb_form_v1">
                                <h2 class="mb-4 mt-0 text-center">Admin Sign Up</h2>
                                ...
                                <div class="form-group">
                                    <asp:TextBox id="TextBoxCompanyPassword1" CssClass="form-control pb_height-50 reverse" placeholder="Password" TextMode="Password" runat="server"/>
                                </div>
                                <div class="form-group">
                                    <asp:TextBox id="TextBoxCompanyPassword2" CssClass="form-control pb_height-50 reverse" placeholder=" Re-Enter Password" TextMode="Password" runat="server"/>
                                </div>
                                <div class="form-group">
                                    <asp:Button id="SignUpButton" CssClass="btn btn-primary btn-lg btn-block pb_btn-pill  btn-shadow-blue" OnClick="SignUpButton_Click" Text="Sign Up" runat="server"/>
                                </div>                               
                                <div class="form-group">
                                    <asp:Label runat="server" id="ErrorLabel" Text="" CssClass="labelErrorMessage" ForeColor="Red"/>
                                </div>
                                <div class="form-group" style="text-align: center">
                                    <asp:Button id="LoginInsteadButton"  CssClass="btn-form-switch" OnClick="LoginInsteadButton_Click" Text="Login Instead" runat="server"/>
                                </div>
                            </div>
                        </div>
                    </div>
